...
namespace NostreetsExtensions.Helpers.SqlTranslator {
    ...
    public class TestHarness
    {
        ...
        protected void RunTests(LinqProvider provider, string baselineFile, string newBaselineFile, bool executeTests)
        {
    ...
    public class NorthwindTestHarness : TestHarness
    {
        ...
        {
            this.db = db;
            LinqProvider provider = (LinqProvider)((IQueryable)db.Customers).Provider;
